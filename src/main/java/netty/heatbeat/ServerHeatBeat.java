...
public class ServerHeatBeat {
    ...
    public static void main(String[] args) {
        ...
        ServerHeatBeat server = null;
        try {
            server = new ServerHeatBeat();
            future = server.doAccept(9999,new ServerHeatBeatHandler());
